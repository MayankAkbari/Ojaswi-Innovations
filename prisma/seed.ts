  ...
  for (let i = 0; i < portfolioData.length; i++) {
    ...
    await prisma.portfolioItem.create({
      data: {
        ...
        thumbnailUrl: i === 0 ? '/portfolio/aarogya-logo.png' : i === 1 ? '/portfolio/shree-fabrics-logo.png' : i === 2 ? '/portfolio/apex-corrugated-logo.png' : i === 4 ? '/portfolio/vogue-spaces-logo.png' : i === 5 ? '/portfolio/royal-heritage-logo.png' : `https://images.unsplash.com/photo-${1500000000000 + i * 1000000}?auto=format&fit=crop&w=600&q=80`,
        liveUrl: i === 0 ? 'https://aarogya-multi-specialty-hospital.vercel.app/' : i === 1 ? 'https://shree-fabrics-export-corp.vercel.app/' : i === 2 ? 'https://apex-corrugated-solutions.vercel.app/' : i === 4 ? 'https://vogue-spaces-interior-studio.vercel.app/' : i === 5 ? 'https://the-royal-heritage-resort.vercel.app/' : 'https://ojaswi.com/demo',
        order: i + 1
      }
    });
  }
